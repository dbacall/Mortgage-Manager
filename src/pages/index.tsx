...
import { BiRefresh, BiHelpCircle } from 'react-icons/bi';
      ...
      <div className="drawer drawer-mobile">
        ...
        <div className="drawer-side">
          ...
          <ul className="menu p-4 bg-slate-100 text-base-content w-64">
            <li className="text-slate-500"><a><BiRefresh size={20} /> Client Renewals</a></li>
            <li className="text-slate-500"><a><IoHelpSharp size={20} /> Help</a></li>
          </ul>
